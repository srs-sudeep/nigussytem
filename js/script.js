...
(function () {
  ...
  $(document).ready(function () {
    // Typewriting effect for h2 element
    var h2 = $(".h2-one");
    var h2Text = h2.text();
    h2.text(""); // Clear the h2 content

    var h2Index = 0;
    var h2Timer = setInterval(function () {
      h2.text(h2.text() + h2Text[h2Index]);
      h2Index++;
    ...
    // Typewriting effect for span element
    var span = $(".span-h1-content");
    var spanText = span.text();
    span.text(""); // Clear the span content

    var spanIndex = 0;
    var spanTimer = setInterval(function () {
      span.text(span.text() + spanText[spanIndex]);
      spanIndex++;
  ...
  function reveal() {
    ...
    for (var i = 0; i < reveals.length; i++) {
      ...
      if (elementTop < windowHeight - elementVisible) {
        ...
        // Trigger animation for dot files
        var dotFiles = reveals[i].querySelectorAll(".features-mainDiv .pop");
        dotFiles.forEach(function(dotFile, index) {
          setTimeout(function() {
            dotFile.classList.add("active");
